...
class __TwigTemplate_154b5116404fba99f3760cb63997b7fe3ea22661121d7004f8969eeb78e7d4dc extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn-lg btn-success\">{{ 'Save'|trans }}</button>
{{ form_end(form) }}", "admin/_form.html.twig", "C:\\Users\\DELL XPS\\PhpstormProjects\\PROJEKT\\templates\\admin\\_form.html.twig");
    }
}
